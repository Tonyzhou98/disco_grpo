...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--advantage_estimator",
        type=str,
        choices=["gae", "reinforce", "rloo", "reinforce_baseline", "group_norm", "group_norm_diff", "group_norm_domain", "group_norm_wo_std"],
        default="gae",
        help="Choose advantage estimation method: gae, reinforce, rloo, reinforce_baseline, group_norm, group_norm_diff, group_norm_domain, group_norm_wo_std",
    )
    ...
    if args.advantage_estimator in ["rloo", "reinforce_baseline", "group_norm", "group_norm_diff", "group_norm_domain", "group_norm_wo_std"]:
