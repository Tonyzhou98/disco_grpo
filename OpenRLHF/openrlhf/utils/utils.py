...
def get_tokenizer(pretrain, model, padding_side="left", strategy=None, use_fast=True):
    ...
    if "olmoe" in pretrain.lower():
        print("Olmoe model does not have chat_template, set instruct model chat_template to base model")
        instruct_tokenizer = AutoTokenizer.from_pretrained("allenai/OLMoE-1B-7B-0125-Instruct")
